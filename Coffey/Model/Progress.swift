...
class Progress: Identifiable, Hashable, Decodable {
    ...
    static let mockProgresses: [Progress] = [
        Progress(progress_id:1, user_id: 1, content_id: 1, status: ProgressStatus.notStarted),
        Progress(progress_id:2, user_id: 1, content_id: 2, status: ProgressStatus.inProgress),
        Progress(progress_id:3, user_id: 1, content_id: 3, status: ProgressStatus.completed)
    ]
}
